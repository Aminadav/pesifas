...
function showNodes(oDiv) {
	if (oDiv.children[1]) {
		oDiv.children[1].style.pixelTop = oDiv.children[0].offsetTop;
...
function showFirstNode(oDiv) {
	if (oDiv.children[1]) {
		oDiv.children[1].style.pixelTop = oDiv.children[0].offsetTop;
		oDiv.children[1].style.pixelLeft = oDiv.children[0].offsetLeft - oDiv.children[1].offsetWidth+30;
		oDiv.children[1].style.visibility = "visible";
	}
}
